-- creating two tables for performing Inner join
use db;
...
select student.Roll_No,student.name,studentCourse.course_id from student INNER JOIN studentCourse on student.Roll_No=studentCourse.Roll_No;