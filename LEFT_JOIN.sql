-- creating two tables for performing Left join
use db;
...
select student.Roll_No,student.name,studentCourse.course_id from student LEFT JOIN studentCourse on student.Roll_No=studentCourse.Roll_No;